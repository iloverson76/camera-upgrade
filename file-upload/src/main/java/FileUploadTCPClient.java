...
class FileUploadTCPClient extends JFrame implements ActionListener, MouseListener {
    JPanel panel;
    ...
    public FileUploadTCPClient(String dir, String host, int port) {
        super("TCP CLIENT");
    ...
    public static void main(String args[]) {//directory/host addres/port
        ...
        if(args.length >= 3){
            FileUploadTCPClient tcp = new FileUploadTCPClient(args[0], args[1], Integer.parseInt(args[2]));
            tcp.setSize(1000, 900);
            tcp.setVisible(true);
        }
        else if(args.length == 2){
            FileUploadTCPClient tcp = new FileUploadTCPClient(args[0], args[1], 3333);
            tcp.setSize(1000, 900);
            tcp.setVisible(true);
        }
        else if(args.length == 1){
            FileUploadTCPClient tcp = new FileUploadTCPClient(args[0], "localhost", 3333);
            tcp.setSize(1000, 900);
            tcp.setVisible(true);
        }
        else {
